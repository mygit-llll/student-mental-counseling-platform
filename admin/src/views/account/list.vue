  ...
  <div class="app-container">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      ...
      >
        ...
        <!-- <el-form-item label="密码1" prop="password" required
...
<script>
import { list as getAccountList, search, register, remove, adminUpdateAccount } from '@/api/account'
...
export default {
  ...
  methods: {
    ...
    updateAccount() {
      this.$refs.tmpAccount.validate(valid => {
        if (valid) {
          adminUpdateAccount(this.tmpAccount.id, {
            id: this.tmpAccount.id,
