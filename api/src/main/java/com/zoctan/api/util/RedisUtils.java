...
public class RedisUtils {
  ...
  /**
   * 获取布尔值，支持默认值（解决 NPE 问题）
   *
   * @param key 键
   * @param defaultValue 默认值
   * @return 布尔值
   */
  public Boolean getBooleanValue(@NotBlank final String key, Boolean defaultValue) {
  ...
  /**
   * 获取布尔值，默认为 false（解决 NPE 问题）
   *
   * @param key 键
   * @return 布尔值
   */
  public Boolean getBooleanValue(@NotBlank final String key) {
   ...
   * @return 字符串值
   */
  public String getStringValue(@NotBlank final String key, String defaultValue) {
    Object value = this.getValue(key);
    return value != null ? value.toString() : defaultValue;
  }

  /**
   * 获取字符串值，默认为 null（解决 NPE 问题）
   *
   * @param key 键
   * @return 字符串值
   */
  public String getStringValue(@NotBlank final String key) {
   ...
   * @return 数值
   */
  public Long getLongValue(@NotBlank final String key, Long defaultValue) {
    Object value = this.getValue(key);
    if (value == null) {
      return defaultValue;
    }
  ...
  /**
   * 获取数值，默认为 0（解决 NPE 问题）
   *
   * @param key 键
   * @return 数值
   */
  public Long getLongValue(@NotBlank final String key) {
